...
| Case Type  | Example      | First Letter | Separator |
| ---------- | ------------ | ------------ | --------- |
| snake_case | student_name | lowercase    | _         |
| camelCase  | studentName  | lowercase    | None      |
| PascalCase | StudentName  | Capital      | None      |
...
* Support teamwork
* Follow professional coding standards(PEP-8)
